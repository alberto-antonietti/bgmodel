 ...
 */
extern "C" int my_aeif_cond_exp_dynamics (double, const double*, double*, void*);
...
inline nest::port
  mynest::my_aeif_cond_exp::send_test_event(nest::Node& target,
...
inline nest::port
mynest::my_aeif_cond_exp::handles_test_event(nest::SpikeEvent&, nest::rport receptor_type)
{
...
inline nest::port
mynest::my_aeif_cond_exp::handles_test_event(nest::CurrentEvent&, nest::rport receptor_type)
{
